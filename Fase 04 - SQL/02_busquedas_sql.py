...
print("\n--- 🔍 BUSCANDO MAYORES DE EDAD (>18) ---")

# La orden SQL: "Selecciona TODO de usuarios DONDE la edad sea mayor o igual a 18"
sql_busqueda = "SELECT * FROM usuarios WHERE edad >= 18"
...
cursor.execute("SELECT * FROM usuarios WHERE nombre = 'Daniel'")
